...
AUTH_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNEL', '-1002441208913').split()] # give channel id with seperate space. Ex : ('-10073828 -102782829 -1007282828')
...
WEBSITE_URL = environ.get("WEBSITE_URL", "https://www.google.co.in/url?sa=t&source=web&rct=j&opi=89978449&url=https://technologygyanallinone.blogspot.com/2025/01/the-ultimate-guide-to-technology-and.html") # For More Information Check Video On Yt - @Tech_VJ
